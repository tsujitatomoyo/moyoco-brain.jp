...
<h2 class="works_hp_ttl">東京ベルエポック美容専門学校　<br class="Box-sp">ベルダンシページ</h2>
...
<div class="works_modal_wrap">
    <div id="modal01" class="modal js-modal">
        ...
        <div class="modal__content">
            ...
            <img src="<?php echo get_template_directory_uri(); ?>/img/works/hp/hp_002_pc.jpg">
    ...
    <div id="modal02" class="modal js-modal">
        ...
        <div class="modal__content">
			<p class="modal__batu"><a class="js-modal-close" href=""><i class="fas fa-times"></i></a></p>
            <img src="<?php echo get_template_directory_uri(); ?>/img/works/hp/hp_002_sp.jpg">
            <p class="Text-Center"><a class="js-modal-close btn--orange" href="">閉じる</a></p>
        </div><!--modal__inner-->
    </div><!--modal-->
</div>
