...
<div class="works_hp_main_img"><img src="<?php echo get_template_directory_uri(); ?>/img/works/hp/hp_006_main.png" alt=""></div>
<h2 class="works_hp_ttl">札幌ベルエポック製菓調理ウェディング様 <br class="Box-sp">トップページリニューアル</h2>
...
<table>
	<tbody>
		<tr>
			...
			<td><p class="works_p">デザイン/コーディング/ディレクション</p></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><p class="works_p"><a target="_blank" href="https://www.foods.belle.ac.jp/">https://www.foods.belle.ac.jp/</a></p></td>
		</tr>
	</tbody>
</table>
...
<div class="works_modal_wrap">
    <div id="modal01" class="modal js-modal">
        ...
        <div class="modal__content">
            ...
            <img class="w--100" src="<?php echo get_template_directory_uri(); ?>/img/works/hp/hp_006_pc.jpg">
    ...
    <div id="modal02" class="modal js-modal">
        ...
        <div class="modal__content">
			<p class="modal__batu"><a class="js-modal-close" href=""><i class="fas fa-times"></i></a></p>
            <img class="w--100" src="<?php echo get_template_directory_uri(); ?>/img/works/hp/hp_006_sp.jpg">
            <p class="Text-Center"><a class="js-modal-close btn--orange" href="">閉じる</a></p>
        </div><!--modal__inner-->
    </div><!--modal-->
</div>
